...
def detect_sounds(audio_vec, call_type, channel_number, fourier=False, sampling_rate=48000, overlap=0.25):
...
if __name__ == '__main__':
  ...
  times = detect_sounds(audio_vec, call_type, channel, fourier, sampling_rate)
